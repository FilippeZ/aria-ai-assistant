...
from app.face_detector import _resolve_model_path
from rich.console import Console

console = Console()
cfg = Config.load()

# Αφαιρέθηκε το kill_stale_camera_holders (SDK specific)
...
# Χρησιμοποιούμε το OpenCV YN Face Detector όπως είχες ορίσει
...
h, w = frame.shape[:2]
print(f"FRAME {w}x{h}, mean_brightness={frame.mean():.1f}")
...
if faces is not None:
    for f in faces:
        # Τα αποτελέσματα του YN detector είναι συχνά σε numpy array
